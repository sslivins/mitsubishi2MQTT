...
"<div id='l1' name='l1'>"
    "<fieldset>"
        ...
        "<form method='post'>"
            ...
            "</p>"
            "<p><b>WiFi TX Power (dBm)</b>"
                "<br/>"
                "<small>0&ndash;20.5; leave blank for the SDK calibrated default (recommended). Set an explicit value only to cap power on a strong link.</small>"
                "<br/>"
                "<input id='txpower' "
                "autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' "
                "name='txpower' placeholder='default' value='_WIFI_TX_POWER_'>"
            "</p>"
            "<br/>"
            "<button name='save' type='submit' class='button bgrn'>_TXT_SAVE_</button>"
        "</form>"
